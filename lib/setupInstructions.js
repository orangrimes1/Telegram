...
const INSTRUCTIONS = {
  firestick_sideload: [
    ...
    'Install <b>Downloader</b> from the Firestick app store (orange icon with a "D").',
    ...
    .join('\n'),
  android_sideload: [
    'On your Android device, go to <b>Settings → Security</b> and enable <b>Install unknown apps</b> for your browser or file manager.',
    'Install the <b>Downloader</b> app (or download the APK directly in your browser).',
    'Get the <b>IPTV Smarters Pro</b> APK and install it.',
    'Open <b>IPTV Smarters Pro</b>, select <b>Xtream Codes Login</b>, and enter the details above.',
  ]
    .map((line, i) => `${i + 1}. ${line}`)
    .join('\n'),
...
const LABELS = {
  ...
  android_app_store_install: 'Android Phone',
  ios_app_store_install: 'iPhone',
