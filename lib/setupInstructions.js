...
const INSTRUCTIONS = {
  ...
  xbox_install: [
    '1. Install <b>MyIPTV Player</b> from the Microsoft Store on your Xbox, open it, select <b>Xtream Codes login</b>, and enter the server, username, playlist name, and password above.',
  ].join('\n'),
};
...
module.exports = { getSetupInstructions, getSetupLabel, PLAYLIST_NAME, SMARTERS_DOWNLOADER_CODE };
